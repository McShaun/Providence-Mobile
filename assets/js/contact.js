...
$(document).ready(function()	{
	...
	$('#form1').submit(function()	{
		...
		$.ajax({
			url:		'http://www.biblestudyinteractive.com/praise/assets/contact/assets/send.php',
...
function generate_catpcha()	{
	$.ajax({
		url:		'http://www.biblestudyinteractive.com/praise/assets/contact/assets/captcha.php',
		data:		'do=generate',
		dataType:	'json',
		success:	function(data)	{
			if(data.response)	{
